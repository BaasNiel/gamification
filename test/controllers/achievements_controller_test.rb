...
class AchievementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create achievement" do
    assert_difference('Achievement.count') do
      post achievements_url, params: { achievement: { description: @achievement.description, points: @achievement.points, title: @achievement.title } }
    end
  ...
  test "should update achievement" do
    patch achievement_url(@achievement), params: { achievement: { description: @achievement.description, points: @achievement.points, title: @achievement.title } }
